...
location_descriptions = {
	...
	<br><br> Hot Tip: Make sure to bring oxygen tanks, you may be down their for a while (unless your partner has a suffocation fetish, then in that case don’t)",
	...
	<br><br> Hot tip: Pack a picnic basket and enjoy some post-sex snacks at one of the forest’s several streams or braai spots. ",
	...
	<br><br> Hot tip: Since the cottage works on a self-catering basis, why not bring along some sexy eats to set the mood? Think strawberries, oysters and Champagne, and for extra points, whipped cream and body chocolate.",
	...
	<br><br> Hot Tip: Order an Uber XL, ya gonna need the space.",
	...
	<br><br> Hot tip: If the time factor puts too much pressure on you to perform, it may be worth splurging on a private extended sky dining experience for a more leisurely lay. A VIP gondola costs R800 for a half an hour ride and a bottle of sparkling wine.",
	...
	<br><br> Hot tip: Make a Cape Winelands boinking bucket list and see how many farms you can fornicate at without things ending in sour grapes.
	",
	...
	<br><br> Hot Tip: Make sure to do it in front of the wide, full length mirrors, that way, you can watch yourself in action",
	...
	<br><br> Hot Tip: Wanna make the night even more sexy? Why not invite the criminals to join you in a good-old fashion orgy?",
	...
	<br><br> Hot tip: You score bonus points for getting access to the hotel without actually being a paying guest, but it may be worth just booking a room and taking full advantage of all the lodging’s amenities. ",
	...
	<br><br> Hot tip: It’s best to choose this option on overcast days when the beach is less likely to be crowded and you don’t have to worry about being seen, or being heard over the crash of the waves.
	",
	...
	<br><br> Hot tip: Make this a quick one, and practice a little flexibility so that other people will see only one set of legs instead of two.",
	...
	<br><br> Hot tip: Sign up for a membership while you’re there, because there’s nothing sexier than a reader (plus, you then have a solid excuse to keep going back). ",
}
